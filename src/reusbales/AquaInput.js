const AquaInput = ({ label, placeholder, handleChange, type, Address, value, name, maxlength }) => {
    return (
        <>
            {Address ? (
                <>
                    <div class="form-group row row-cols-lg-auto g-1">
                ...
                <>
                    <div class="form-inline mb-3 row row-cols-lg-auto g-1">
                        ...
                        <div class="col-sm-12 col-xs-12 col-lg-8 col-md-8">
                            <input class="form-control" id="inputEmail3" placeholder={placeholder} onChange={handleChange} name={name} maxLength={maxlength} value={value} type={type} />
                        </div>
                    </div>
                </>
            )}
